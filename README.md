# Tarefa de Programação Orientada a Objetos (Interface)
...
Este projeto foi pedido a utilização de Classe Abstrata, sendo 1 Tarefas proposta pelo Professor.
...
* **Versão 1.0** - Inicio do Projeto. *23/10/2024*
* **Versão 1.1** - Criação e Finalização do Projeto e ReadMe *23/10/2024*
